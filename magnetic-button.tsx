...
export const MagneticButton = ({
  ...
  return (
    <div
      ...
      className="cursor-pointer rounded-lg border border-dashed transition-colors duration-150 [--show-color:var(--color-cyan-300)]"
      style={{
        borderColor: hasMoved ? "var(--show-color)" : "transparent",
        backgroundColor: hasMoved
          ? "color-mix(in srgb,var(--show-color) 12%, transparent)"
          : "transparent",
      }}
    >
      <motion.div
